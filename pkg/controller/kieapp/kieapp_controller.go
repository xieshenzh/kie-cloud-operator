...
import (
	...
	appv1 "github.com/kiegroup/kie-cloud-operator/pkg/apis/app/v1"
...
var log = logf.Log.WithName("controller_kieapp")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1.KieApp{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner KieApp
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1.KieApp{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileKieApp) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling KieApp")

	// Fetch the KieApp instance
	instance := &appv1.KieApp{}
	...
	// Set KieApp instance as the owner and controller
...
func newPodForCR(cr *appv1.KieApp) *corev1.Pod {
